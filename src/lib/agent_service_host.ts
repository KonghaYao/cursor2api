...
export function createAgentServiceHost(opts?: {
...
/** In-repo AgentService/Run host (tests and probes). */
export function defaultAgentServiceHost(): CustomToolAgentHost {
  return createAgentServiceHost();
}
